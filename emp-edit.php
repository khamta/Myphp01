                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="empno" placeholder="ກະລຸນາປ້ອນລະຫັດພະນັກງານ" name="empno" value="<?= @$empno ?>" required readonly>
                                            </div>
                                        </div>
                                        <!-- 2, ຊື່ພະນັກງານ -->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div style="text-align: center">
                                                <img id='img-upload' />
                                                <div id="temp_img">
                                                    <img src="images/<?= $file_image ?>" alt="" width="150px" height="180px" />
                                                </div>
                                                <!--ເລືອກຮູບພາບ-->
                                                <br>
